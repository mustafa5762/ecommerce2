              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div className="space-y-6 border-t border-gray-200 py-6 px-4">
                  <div className="flow-root">
                    <a onClick={() => setOpenn(true)} className="-m-2 block p-2 font-medium text-gray-900">
                      Sign in
                    </a>
                  </div>
                  <div className="flow-root">
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                { !user &&<div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a onClick={() => setOpenn(true)} className="text-sm font-medium text-gray-700 hover:text-gray-800">
                    Sign in
                  </a>
